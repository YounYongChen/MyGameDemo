...
namespace Kill.StateMachine.Editor
{
	internal class TransitionTableEditorWindow : EditorWindow
	{
		private static TransitionTableEditorWindow _window;
		private static readonly string _uxmlPath = "Assets/Code/StateMachine/Editor/TransitionTableEditorWindow.uxml";
		private static readonly string _ussPath = "Assets/Code/StateMachine/Editor/TransitionTableEditorWindow.uss";
		private bool _doRefresh;

		private UnityEditor.Editor _transitionTableEditor;

		[MenuItem("State Machine Editor", menuItem = "Kill/State Machine Editor")]
