...
public static class ETCMenu{
	...
	static void  AddButton(){
		...
		GameObject fgImage = new GameObject("FgImage", typeof(RectTransform), typeof(CanvasRenderer), typeof(Image));
		fgImage.transform.SetParent(button.transform, false);
		fgImage.GetComponent<Image>().rectTransform.anchorMin = new Vector2(0.0f, 0.0f);
		fgImage.GetComponent<Image>().rectTransform.anchorMax = new Vector2(1.0f, 1.0f);
		fgImage.GetComponent<Image>().rectTransform.offsetMin = new Vector2(0.0f, 0.0f);
		fgImage.GetComponent<Image>().rectTransform.offsetMax = new Vector2(0.0f, 0.0f);
		fgImage.GetComponent<Image>().sprite = button.GetComponent<ETCButton>().fgSprite;
		fgImage.GetComponent<Image>().color = button.GetComponent<ETCButton>().fgColor;
		button.GetComponent<ETCButton>().fgImage = fgImage.GetComponent<Image>();
		button.GetComponent<ETCButton>().fgRect = fgImage.GetComponent<RectTransform>();

		GameObject cdImage = new GameObject("CoolDownImage", typeof(RectTransform), typeof(CanvasRenderer), typeof(Image));
		cdImage.transform.SetParent(button.transform, false);
		cdImage.GetComponent<Image>().rectTransform.anchorMin = new Vector2(0.0f, 0.0f);
		cdImage.GetComponent<Image>().rectTransform.anchorMax = new Vector2(1.0f, 1.0f);
		cdImage.GetComponent<Image>().rectTransform.offsetMin = new Vector2(0.0f, 0.0f);
		cdImage.GetComponent<Image>().rectTransform.offsetMax = new Vector2(0.0f, 0.0f);
		cdImage.GetComponent<Image>().sprite = button.GetComponent<ETCButton>().coolDownSprite;
		cdImage.GetComponent<Image>().color = button.GetComponent<ETCButton>().coolDownColor;
		cdImage.GetComponent<Image>().type = Image.Type.Filled;
		cdImage.GetComponent<Image>().fillMethod = Image.FillMethod.Radial360;
		button.GetComponent<ETCButton>().coolDownImage = cdImage.GetComponent<Image>();
		button.GetComponent<ETCButton>().coolDownRect = cdImage.GetComponent<RectTransform>();
